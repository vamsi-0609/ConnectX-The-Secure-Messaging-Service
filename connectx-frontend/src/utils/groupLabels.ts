...
export const WHO_CAN_SEND_MESSAGES_OPTIONS: { value: WhoCanSendMessages; label: string; description: string }[] = [
  ...
  { value: 'ADMINS_ONLY', label: 'Only admins', description: 'Only owners and admins can send messages' },
];

export const WHO_CAN_INVITE_OPTIONS: { value: WhoCanInvite; label: string; description: string }[] = [
  { value: 'ALL_MEMBERS', label: 'All members', description: 'Any member can add or invite people' },
...
export const WHO_CAN_EDIT_GROUP_INFO_OPTIONS: { value: WhoCanEditGroupInfo; label: string; description: string }[] = [
  { value: 'ALL_MEMBERS', label: 'All members', description: 'Any member can edit the group name and photo' },
...
export const GROUP_ADD_PRIVACY_OPTIONS: { value: GroupAddPrivacy; label: string; description: string }[] = [
  { value: 'ANYONE', label: 'Anyone', description: 'Any ConnectX user can add you to a group' },
  { value: 'CONNECTIONS', label: 'Connections', description: 'Only people you\'re connected with can add you' },
